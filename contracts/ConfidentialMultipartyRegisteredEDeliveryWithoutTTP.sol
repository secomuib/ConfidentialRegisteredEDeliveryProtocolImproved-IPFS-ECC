...
// Amb https://github.com/zcoinofficial/solidity-BigNumber/
...
contract ConfidentialMultipartyRegisteredEDeliveryWithoutTTPFactory {
    ...
    function createDelivery(address[] _receivers, bytes _c1, string memory _c2, bytes _ya, bytes _g, bytes _p, uint _term1, uint _term2) public payable {
...
contract ConfidentialMultipartyRegisteredEDeliveryWithoutTTP {
    ...
    constructor (address _sender, address[] _receivers, bytes _c1, string memory _c2, bytes _ya, bytes _g, bytes _p, uint _term1, uint _term2) public payable {
